...
const reviews = [
  ...
  { name: "Richard Feenstra", meta: "6 dagen geleden", img: "/images/richard-feenstra-v2.png", text: '"Thomas heeft mij geholpen om mijn website weer een beetje up-to-date te krijgen. De korte lijntjes zijn erg prettig. De afspraken zijn netjes nagekomen. Al met al een goede ervaring."' },
